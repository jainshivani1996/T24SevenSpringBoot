...
<form:form id="login" class="input-group" action="updateEmailDetail"
		method="post" modelAttribute="customer">
		
<input type="tel"  id="phoneNo" name="phoneNo" class="input-field" placeholder="Enter New Phone Number">

<br>
<input type="email" id="email" name="email" class="input-field" placeholder="Enter New Email Id">
<br>
<button type="submit" class="submit-btn">Update</button><br>
<div style="color:white" style= "font-size:14px">${msg}</div>
</form:form>
